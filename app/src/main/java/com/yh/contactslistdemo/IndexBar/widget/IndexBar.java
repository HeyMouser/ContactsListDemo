package com.yh.contactslistdemo.IndexBar.widget;
...
import com.yh.contactslistdemo.CityBean;
import com.yh.contactslistdemo.IndexBar.bean.BaseIndexPinyinBean;
import com.yh.contactslistdemo.R;
...
public class IndexBar extends View {
    ...
    private void initSourceDatas() {
        ...
        for (int i = 0; i < size; i++) {
            CityBean indexPinyinBean = (CityBean) mSourceDatas.get(i);
            StringBuilder pySb = new StringBuilder();
            String target = indexPinyinBean.getCity();//取出需要被拼音化的字段
